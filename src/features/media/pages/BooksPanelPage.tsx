...
function BooksPanelPage() {
  const { logs, loading, createLog, updateLog, deleteLog, toggleFavorite } = useMediaLogs("book");
  ...
  return (
    <>
      ...
      {loading ? (
        <div className="text-muted-foreground text-sm">Loading your books…</div>
        ...
        <div className="flex flex-col items-center justify-center py-20 border border-dashed border-border rounded-xl text-center gap-4">
          ...
          <p className="text-muted-foreground text-sm">
            {favoritesOnly ? "No favorited books yet." : "No books logged yet."}
          </p>
          {!favoritesOnly && (
